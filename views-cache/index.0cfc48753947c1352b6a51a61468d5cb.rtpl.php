...
<body>
    <nav>
        <div class="container">
            <a class="li" href="/"><img class="logomarca" src="imagens/ourocenter-logo.png" alt="logomarca" height="50" width="200"></a>
    ...
    <footer>
        <br>
        <h3>® TODOS OS DIREITOS RESERVADOS <?php echo getYear(); ?> </h3>
        <br>
            <div class="rodape"> 
